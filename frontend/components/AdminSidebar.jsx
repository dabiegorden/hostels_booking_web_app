...
import { AdminSidebarLinks, hostelOwnersDashboard } from '@/constants';
...
const AdminSidebar = ({ toggleSidebar }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-indigo-800 to-indigo-900 text-white shadow-xl">
      {/* Sidebar Content */}
      <nav className="flex flex-col h-full px-3 py-6 space-y-2">
