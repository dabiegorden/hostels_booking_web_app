  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || `Failed to create hostel owner: ${response.status} ${response.statusText}`)
      }
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-xl md:text-2xl font-bold">Create New Hostel Owner</h1>
      </div>
