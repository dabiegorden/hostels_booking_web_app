...
import { HostelOwnersNavbar, HostelOwnersSidebar } from '@/constants';
import React, { useState } from 'react';
import cugLogo from "@/public/assets/cug-logo.jpg";
import Image from 'next/image';

const HostelOwnersLayout = ({ children }) => {
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-30">
        <div className="flex justify-between items-center bg-white h-16 px-4 shadow">
          ...
          <div className="flex-1 px-4">
            <HostelOwnersNavbar isMobile={true} />
          </div>
        </div>
      </div>
        ...
        >
          <div className="flex flex-col h-full">
              ...
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-sm sm:text-base md:text-xl font-bold truncate">Hostel Manager</h1>
              </div>
            </div>
            <div className="flex-1 overflow-hidden">
              <HostelOwnersSidebar toggleSidebar={toggleSidebar} />
            </div>
          </div>
        </aside>
...
export default HostelOwnersLayout;