...
import { Home, DollarSign, ImageIcon, Plus, X, Loader, ArrowLeft, Save, AlertCircle } from "lucide-react"
...
export default function EditRoomPage({ params }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Redirect to room details page after a short delay
      setTimeout(() => {
        router.push(`/hostel-owners-dashboard/rooms/${roomId}`)
      }, 1000)
    } catch (err) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        <Link
          href={`/hostel-owners-dashboard/rooms/${roomId}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select
              ...
              required
            >
              <option value="1 in 1">Single (1 in 1)</option>
              <option value="2 in 1">Double (2 in 1)</option>
              <option value="3 in 1">Triple (3 in 1)</option>
              <option value="4 in 1">Quad (4 in 1)</option>
