...
const debugRoomFetch = async (hostelId) => {
  try {
    ...
    const roomsResponse = await fetch(
      `http://localhost:5000/api/public/hostels/${hostelId}/rooms`
    );
...
export default function HostelDetailPage({ params }) {
    ...
    const fetchHostel = async () => {
      try {
        ...
        const response = await fetch(
          `http://localhost:5000/api/public/hostels/${id}`
        );
  ...
  if (
    hostel?.amenities &&
    typeof hostel.amenities[0] === "string" &&
    hostel.amenities[0].startsWith("[")
  ) {
    try {
  ...
  const parseRoomAmenities = (roomAmenities) => {
    ...
    if (
      typeof roomAmenities[0] === "string" &&
      roomAmenities[0].startsWith("[")
    ) {
      try {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="mb-5">
          <Link
            href="/hostels"
            className="text-indigo-600 hover:text-indigo-800 font-medium flex items-center group transition-colors duration-200"
          >
            <ChevronLeft
              size={20}
              className="mr-1 group-hover:transform group-hover:-translate-x-1 transition-transform duration-200"
            />
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden mb-6">
          <div className="relative h-64 md:h-80 w-full">
            {hostel.images && hostel.images.length > 0 ? (
              <img
                src={
                  `http://localhost:5000${hostel.images[activeImage]}` ||
                  "/placeholder.svg"
                }
                alt={hostel.name}
                  ...
                  {hostel.rating > 0 && (
                    <div className="flex items-center bg-white/90 px-3 py-1 rounded-full">
                      ...
                      <span className="text-gray-700 ml-1">
                        ...
                        {hostel.reviews.length === 1 ? "review" : "reviews"})
                      </span>
                    </div>
                  )}
                </div>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-gray-50 p-5 rounded-lg">
                  ...
                  <ul className="space-y-2">
                    {Array.isArray(parsedAmenities) &&
                      parsedAmenities.slice(0, 4).map((amenity, index) => (
                        <li
                          key={index}
                ...
                <div className="bg-gray-50 p-5 rounded-lg">
                  ...
                  <p className="text-gray-700 mb-4">
                    Rooms are available for monthly booking. Select a room to
                    see availability and pricing details.
                  </p>
                  <button
                    onClick={() => setActiveTab("rooms")}
              ...
              {roomsLoading ? (
                ...
                <div className="text-center py-12 bg-yellow-50 rounded-lg border border-yellow-100">
                  ...
                  <p className="text-gray-600">
                    Please check back later or contact the hostel directly for
                    more information.
                  </p>
                </div>
              ) : (
                      ...
                      <div className="p-5">
                        ...
                        <div className="flex flex-wrap gap-4 mb-4">
                          <div className="flex items-center text-sm text-gray-600">
                            <Home size={16} className="mr-1 text-indigo-500" />{" "}
                            {room.type}
                          </div>
                          <div className="flex items-center text-sm text-gray-600">
                        ...
                        {room.amenities && room.amenities.length > 0 && (
                          <div className="mb-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                              ...
                              {parseRoomAmenities(room.amenities).length >
                                3 && (
            ...
            <div className="p-6">
              ...
              {Array.isArray(parsedAmenities) && parsedAmenities.length > 0 ? (
                ...
                <p className="text-gray-600 text-center py-8">
                  No amenities information available for this hostel.
                </p>
              )}
            </div>
          )}
          ...
          {activeTab === "policies" && (
            <div className="p-6">
              ...
              {hostel.policies ? (
                ...
                <p className="text-gray-600 text-center py-8">
                  No specific policies information available for this hostel.
                </p>
              )}
              ...
              <div className="mt-8 p-4 bg-yellow-50 border border-yellow-100 rounded-lg">
                ...
                <p className="text-gray-700">
                  Please read all policies carefully before booking. For any
                  questions or special arrangements, contact the hostel
                  directly.
                </p>
              </div>
            </div>
