...
export default function BookingDetailsPage({ params }) {
  ...
  const calculatePaymentAmount = (booking) => {
    return booking.paymentStatus === "Partial Payment"
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span
                      className={`inline-flex items-center px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-200 ${getStatusBadgeClass(
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <span
                      className={`inline-flex items-center px-4 py-2 rounded-xl text-sm font-semibold transition-all duration-200 ${getPaymentStatusBadgeClass(
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors duration-200">
                    ...
                    <p className="font-semibold text-lg">
                      {booking.room?.capacity || "N/A"} person(s)
                    </p>
                  </div>
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-colors duration-200">
                    ...
                    <p className="font-semibold text-lg">
                      {booking.student?.phoneNumber || "N/A"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="text-center">
                    ...
                    <span
                      className={`inline-flex items-center px-4 py-2 rounded-xl text-sm font-semibold ${getPaymentStatusBadgeClass(
                        booking.paymentStatus
                      )}`}
                    >
                      <DollarSign className="w-4 h-4 mr-1" />
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                      ...
                      <span className="font-bold text-green-800">
                        GH₵ {calculatePaymentAmount(booking)}
                      </span>
                    </div>
                    ...
                    {booking.paymentStatus === "Partial Payment" && (
                      <div className="flex justify-between items-center p-3 bg-amber-50 rounded-lg">
                        ...
                        <span className="font-bold text-amber-800">
                          GH₵ {calculateRemainingAmount(booking)}
                        </span>
                      </div>
                    )}
                  </div>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-amber-700 leading-relaxed">
                          Complete your payment before check-in to avoid any
                          booking complications. Your reservation is secured
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-green-100 text-sm">
                        Your reservation is secured. We'll send you a reminder
                        closer to your check-in date.
                      </p>
                    </div>
                  </div>
                </div>
