...
import { Check, Download, FileText, Info, ArrowLeft, Star, Calendar, MapPin, CreditCard, Sparkles } from "lucide-react"
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 relative">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
            Congratulations! Your booking at <span className="font-semibold text-indigo-600">{booking.hostel?.name || "the hostel"}</span> is now fully confirmed and paid.
          </p>
        </div>
