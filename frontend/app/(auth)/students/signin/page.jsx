    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-4">
              <span>Don't have an account yet? <Link className='text-blue-500' href={"/"}>Sign up</Link></span>
          </div>
          <div className="mt-4">
              <span>Are you an admin? <Link className='text-blue-500' href={"/admin"}>Signin</Link></span>
          </div>
        </div>
      </div>
    </div>
